 ...
 * Two-Ray Ground, or ITU R-P.1411), and application traf fic
...
VanetRoutingExperiment::SetupScenario ()
{
  ...
  if (m_scenario == 1)
    ...
    {
      // Realistic vehicular trace in near infopark
      // "low density, 25 total vehicles"
      m_traceFile = "/home/rajagiri/mobility.tcl";
      m_logFile = "mobbryan.log";
      m_mobility = 1;
      m_nNodes = 25;
      m_TotalSimTime = 30.01; //for 300.01 sec
      m_nodeSpeed = 20;
      m_nodePause = 0;
      m_CSVfileName = "mobbryan.csv";
      m_CSVfileName = "mobbryan2.csv";
    }
}
